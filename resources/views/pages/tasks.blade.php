            ...
            <nav class="space-y-1">
                @php
                    $navItems = [
                        ...
                        ['label' => 'My Tasks', 'icon' => 'fa-tasks', 'route' => 'tasks', 'active' => true, 'badge' => '5'],
['label' => 'Calendar', 'icon' => 'fa-calendar-alt', 'route' => 'dashboard', 'active' => false, 'badge' => null],
                        ['label' => 'Time Manage', 'icon' => 'fa-clock', 'route' => 'time-manage', 'active' => false, 'badge' => '3'],
                        ['label' => 'Reports', 'icon' => 'fa-chart-bar', 'route' => 'reports', 'active' => false, 'badge' => null],
                        ['label' => 'Settings', 'icon' => 'fa-cog', 'route' => 'settings', 'active' => false, 'badge' => null],
                    ];
                @endphp
